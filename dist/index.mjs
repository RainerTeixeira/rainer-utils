...
export { COOKIE_CONSENT_KEY, COOKIE_PREFERENCES_KEY, COOKIE_VERSION, CURRENCY_MAP, CookieManager, DEFAULT_LOCALE, UserRole, adjustBrightness, adjustHue, adjustSaturation, authentication, calculateChange, calculateMovingAverage, calculateReadingTime, capitalize, cleanText, cn, convertToWebP, copyToClipboard, countWords, darken, datetime, downloadFile, extractInitials, findMinMax, formatCNPJ, formatCPF, formatCurrency, formatDate, formatDateTime, formatNumber, formatPercentage, formatPhone, formatRelativeDate, fuzzySearch, generateAvatarUrl, generateDynamicAvatarUrl, generateMockChartData, generatePlaceholder, generateUniqueId, getAnalogousPalette, getAvatarColorFromName, getComplementary, getCookieManager, getCookiePreferences, getElementPosition, getImageInfo, getInitials, getRefreshToken, getStatusColor, getStatusVariant, getToken, getTokens, groupDataByPeriod, hasCookieConsent, hasToken, hexToHsl, hexToRgb, hexToRgba, hslToHex, isAcceptedFormat, isCNPJ, isCPF, isCookieAllowed, isDarkMode, isElementVisible, isEmpty, isMobile, isValidAvatarUrl, isValidDate, isWebP, lighten, normalizeSpaces, onDarkModeChange, onReducedMotionChange, prefersReducedMotion, prepareImageForUpload, pt_br_exports as ptBR, removeToken, resizeImage, rgbToHex, saveCookieConsent, scrollToElement, scrollToPosition, scrollToTop, searchContent, searchWithScore, setRefreshToken, setToken, setTokens, smoothScrollTo, stateManagement, supportsWebP, textProcessing, textToSlug, toISOString, translatePostStatus, translateStatus, truncate, truncateText, useAuth, useCounter, useCurrentUser, useHasRole, useIntersectionObserver, useIsAdmin, useIsAuthenticated, useIsMobile, usePasswordStrength, useScrollPosition, useSmoothScroll, useToggleState, validateEmail, validateMessage, validatePassword, validatePhone, validateSlug, validateText, validateUrl, validateUsername };
