...
export { COOKIE_CONSENT_KEY, COOKIE_PREFERENCES_KEY, COOKIE_VERSION, CookieManager, getCookieManager, getCookiePreferences, hasCookieConsent, isCookieAllowed, saveCookieConsent };
